export default {
  ...
  contextmenu: {
    ...
    level5: 'Level5',
    level6: 'Level6',
    startTopicTraversal: 'Start Topic Traversal',
    startTraversalFromHere: 'Start Traversal from Here',
    startTraversalFromRoot: 'Start Traversal from Root',
    zenMode: 'Zen mode',
  ...
  export: {
    ...
    batchExportDesc: 'Export multiple file formats simultaneously, packaged as ZIP file',
    selectAtLeastOne: 'Please select at least one export format',
    batchExportSuccess: 'Batch export successful, {count} files exported',
    batchExportPartial: 'Batch export partially successful, {success} succeeded, {fail} failed',
  ...
  demonstrate: {
    ...
    demonstrateFromCurrent: 'Demonstrate from current node',
    layeredMode: 'Toggle layered demonstration mode'
  },
  import: {
    title: 'Import',
  ...
  ai: {
    ...
    confirm: 'Confirm',
    close: 'Close',
    emptyNode: 'Node content cannot be empty',
    ...
    providerValidateTip: 'Please select a model provider',
    ...
    userPromptPlaceholder: 'Use Feynman-style language (default)',
    userPromptRequired: 'Please fill in the user prompt',
    systemPromptContent: 'Please continue writing based on the following content: {text}',
    analyzing: 'Analyzing...',
    suggestError: 'Failed to get suggestion',
    appliedSuggestion: 'Suggestion applied',
    suggest: 'AI Suggestion',
    suggestStarting: 'Generating AI suggestions...',
    suggestProcessing: 'AI is processing your request, please wait patiently...',
    suggestSuccess: 'AI suggestions generated successfully',
    suggestCancel: 'Cancel',
    explain: 'AI Explanation',
    explainStarting: 'Generating AI explanation...',
    explainProcessing: 'AI is processing your request, please wait patiently...',
    explainSuccess: 'AI explanation generated successfully',
    explainError: 'Failed to get explanation',
    appliedExplanation: 'Explanation applied',
    explainCancel: 'Cancel',
    noApiKey: 'AI API key not configured',
    requestFailed: 'AI request failed: {{error}}',
    noApiUrl: 'AI API URL not configured',
    invalidMethod: 'Invalid HTTP request method',
    emptyNode: 'Node content is empty',
    connectFailedTitle: 'Connection Failed',
    close: 'Close',
    stopGenerating: 'Stop Generating',
    generationFailed: 'Generation Failed',
    stoppedGenerating: 'Generation Stopped',
    aiGenerationSuccess: 'AI Generation Successful'
  },
  note: {
    title: 'Note'
  },
  ...
  topicTraversal: {
    ...
    shortcuts: 'Shortcuts',
    nextShortcut: 'Next topic',
    previousShortcut: 'Previous topic',
    depthFirstShortcut: 'Depth first traversal',
    breadthFirstShortcut: 'Breadth first traversal',
    exitShortcut: 'Exit traversal mode'
  }
}