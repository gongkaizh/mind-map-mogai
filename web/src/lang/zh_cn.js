export default {
  ...
  contextmenu: {
    ...
    level5: '五级主题',
    level6: '六级主题',
    startTopicTraversal: '开始主题遍历',
    startTraversalFromHere: '从此节点开始遍历',
    startTraversalFromRoot: '从根节点开始遍历',
    zenMode: '禅模式',
    fitCanvas: '适应画布',
    removeImage: '移除图片',
  ...
  export: {
    ...
    filename: '导出文件名称',
    exportFailed: '导出失败',
    exportBrowserBlocked: '浏览器可能拦截了下载，请检查浏览器下载设置或手动点击下载',
    ...
    confirm: '导出',
    batchExport: '批量导出',
    batchExportDesc: '同时导出多种格式的文件，打包为ZIP文件',
    selectAtLeastOne: '请至少选择一种导出格式',
    batchExportSuccess: '批量导出成功，共导出 {count} 个文件',
    batchExportPartial: '批量导出部分成功，成功 {success} 个，失败 {fail} 个',
  ...
  demonstrate: {
    demonstrate: '进入演示模式',
    demonstrateFromCurrent: '从当前节点开始演示',
    layeredMode: '切换分层演示模式'
  },
  import: {
    title: '导入',
    selectFile: '选取文件',
  ...
  theme: {
    ...
    defaultThemeNote: '设置后，新建思维导图时将使用此主题作为默认主题',
    defaultThemeSetSuccess: '默认主题设置成功'
  },
  toolbar: {
    undo: '回退',
    redo: '前进',
  ...
  ai: {
    ...
    aiCreatePartMsgPostfix: '】的节点的下级内容，节点不要太多，列出最重要的就行',
    aiCreatePartMsgHelp:
      '。需要以Markdown格式返回，并且只能使用Markdown的标题和无序列表两种语法，可以支持多层嵌套。只需返回内容即可。',
    aiCreatePart: 'AI续写',
    systemPrompt: '系统提示词',
    userPrompt: '用户提示词',
    userPromptPlaceholder: '用费曼式的语言来表述(默认)',
    userPromptRequired: '请填写用户提示词',
    systemPromptContent: '请基于以下内容进行续写：{text}',
    analyzing: '正在分析...',
    suggestError: '获取建议失败',
    appliedSuggestion: '已应用建议',
    suggest: 'AI建议',
    suggestStarting: 'AI建议生成中...',
    suggestProcessing: 'AI正在处理您的请求，请耐心等待...',
    suggestSuccess: 'AI建议生成完成',
    suggestCancel: '取消',
    suggestError: 'AI建议生成失败',
    appliedSuggestion: '应用建议',
    regenerate: '重新生成',
    noSuggestionYet: '暂无建议，请点击上方按钮获取AI建议',
    generating: '生成中...',
    noExplanation: '暂无解释，请点击上方按钮获取AI解释',
    explain: 'AI解释',
    explainStarting: 'AI解释生成中...',
    explainProcessing: 'AI正在处理您的请求，请耐心等待...',
    explainSuccess: 'AI解释生成完成',
    explainError: '获取解释失败',
    appliedExplanation: '已应用解释',
    explainCancel: '取消',
    apply: '应用',
    noApiKey: '未配置AI API密钥，请先配置API密钥',
    requestFailed: 'AI请求失败：{{error}}',
    noApiUrl: '未配置AI API地址',
    invalidMethod: '无效的HTTP请求方法',
    unknownError: '未知错误',
    ...
    generationFailed: '生成失败',
    stoppedGenerating: '已停止生成',
    aiGenerationSuccess: 'AI生成成功',

    // 体系化检查相关
    systemCheckTitle: '思维导图体系化检查',
    analyzingSystem: '正在分析思维导图体系化程度...',
    systemScore: '体系化评分',
    detailScores: '详细评分',
    foundIssues: '发现的问题',
    ...
    analyzing: '分析中',
    recheck: '重新检查',
    systemCheckFailed: '体系化检查失败',
    goToNode: '跳转到此处',
    applySuggestion: '应用建议',
    keepDialogOpen: '跳转时保持对话框打开',

    // 评分维度
    structureIntegrity: '结构完整性',
    logicCoherence: '逻辑连贯性',
    hierarchyRationality: '层级合理性',
    contentRichness: '内容丰富度',
    structureBalance: '结构平衡性',
    ...
    // 具体问题类型
    emptyNodeFound: '发现空节点',
    emptyNodeDesc: '节点内容为空，建议补充相关内容',
    singleChildNode: '单子节点',
    singleChildNodeDesc: '该节点只有一个子节点，可考虑合并或增加更多子节点',
    incoherentSiblings: '同级节点不连贯',
    incoherentSiblingsDesc: '同级节点之间缺乏逻辑关联性，建议调整内容或结构',
    tooDeepHierarchy: '层级过深',
    tooDeepHierarchyDesc: '思维导图层级深度为{depth}层，建议控制在6层以内',
    unevenDepth: '层级深度不均',
    unevenDepthDesc: '各分支的深度差异较大，建议平衡各分支的展开程度',
    tooManyShortNodes: '过多简短节点',
    tooManyShortNodesDesc: '超过70%的节点内容过于简短，建议丰富节点内容',
    unbalancedStructure: '结构不平衡',
    unbalancedStructureDesc: '各主要分支的节点数量差异过大，建议平衡各分支的内容',

    // 改进建议
    suggestion: {
      overallImprovement: '整体体系化程度较低，建议从结构完整性、逻辑连贯性等方面进行全面改进',
      improveStructure: '建议完善思维导图结构，填充空节点，优化单子节点情况',
      improveLogic: '建议加强同级节点间的逻辑关联，确保内容连贯性',
      improveHierarchy: '建议优化层级结构，控制深度并平衡各分支的展开程度'
    }
  },
  note: {
    title: '备注'
  ...
  topicTraversal: {
    ...
    shortcuts: '快捷键',
    nextShortcut: '下一个主题',
    previousShortcut: '上一个主题',
    depthFirstShortcut: '深度优先遍历',
    breadthFirstShortcut: '广度优先遍历',
    exitShortcut: '退出遍历模式'
  }
}