export default {
  ...
  export: {
    ...
    batchExportDesc: 'Xuất đồng thời nhiều định dạng tệp, đóng gói thành tệp ZIP',
    selectAtLeastOne: 'Vui lòng chọn ít nhất một định dạng xuất',
    batchExportSuccess: 'Xuất hàng loạt thành công, đã xuất {count} tệp',
    batchExportPartial: 'Xuất hàng loạt thành công một phần, thành công {success}, thất bại {fail}',
    batchExportFailed: 'Xuất hàng loạt thất bại'
  },
  fullscreen: {
  ...
  demonstrate: {
    ...
    demonstrateFromCurrent: 'Trình diễn từ nút hiện tại'
  },
  import: {
    title: 'Nhập',
    selectFile: 'Chọn tệp',
  ...
  ai: {
    ...
    explainStarting: 'Đang tạo giải thích AI...',
    explainProcessing: 'AI đang xử lý yêu cầu của bạn, vui lòng đợi...',
    explainSuccess: 'Giải thích AI đã được tạo thành công',
    explainError: 'Không thể lấy giải thích',
    appliedExplanation: 'Đã áp dụng giải thích',
    explainCancel: 'Hủy',
    modifyAIConfiguration: 'Cấu hình AI',
    regenerate: 'Tạo lại',
    noExplanationYet: 'Chưa có giải thích nào',
    stopGenerating: 'Dừng',
    ...
    userPromptPlaceholder: 'Sử dụng ngôn ngữ kiểu Feynman (mặc định)',
    userPromptRequired: 'Vui lòng điền lời nhắc người dùng',
    systemPromptContent: 'Vui lòng tiếp tục viết dựa trên nội dung sau: {text}'
  },
  note: {
    title: 'Ghi chú'
  },
  ai: {
    emptyNode: 'Nội dung nút không thể để trống',
    requestFailed: 'Yêu cầu AI thất bại: {{error}}',
